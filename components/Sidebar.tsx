...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 left-0 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} lg:relative lg:translate-x-0 transition duration-200 ease-in-out lg:block bg-black w-64 p-6 overflow-y-auto h-full z-20`}>
        <div className="mb-8">
        ...
        <nav className="bg-black">
          <ul className="space-y-4">
            ...
            <li>
              <Link href="/search" className="flex items-center text-white hover:text-white">
                <Search className="mr-4" />
                Zoeken
              </Link>
            </li>
            <li>
              <Link href="/library" className="flex items-center text-white hover:text-white">
        ...
        <div className="mt-8">
          ...
          <button className="flex items-center mt-4 text-white hover:text-white">
